		...
		data(){
			return{
				...
				time_line_list:[
					{
						title:'2015.9',
						title_span:'前身戴尔校园实习生 ',
						content:'燕子去了，有再来的时候；杨柳枯了，有再青的时候；桃花谢了，有再开的时候。'
					},
					{
						title:'2016-2017',
						title_span:'第二年',
						content:'新疆大学 新疆农业大学团队 石河子大学 喀什大学 伊犁师范大学团队成立。'
					},
					{
						title:'2018',
						title_span:'你好',
						content:'联合戴尔 联想 华为 等本地IT品牌办事处共同开发疆才创意社大学生实践平台。'
					},
					{
						title:'2018-2019',
						title_span:'你好',
						content:'完成7所高校校园售后点建立，完成与戴尔 联想 惠普 华为 小米 机械革命 微星 科大讯飞 大疆 vivo OPPO等IT品牌战略合作至今完成12所高校的校园实践团队建立 7所校园售后点 2所高校社团 累计参与人数2000+。'
					},
					{
						title:'2020',
						title_span:'你好',
						content:'2020年至今完成线上小程序上线，打造线上+线下新零售项目运营体系。'
					},
				],
				HEIGHT:0,//屏幕高度
				result:[],//监听的结果
						...
						.line-info-content{
							...
							.info-content-wrap{
								...
								.info-title{
									...
									font-size: 34rpx;
									font-weight: 500;
									span{color: #1177dd;font-size: 37rpx;font-weight: 600;padding-left: 3px;}
